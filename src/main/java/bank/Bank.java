...
public interface Bank {
     ...
     */
    void createAccount(String account) throws AccountAlreadyExistsException, AccountDoesNotExistException, IOException;
     ...
     */
    void createAccount(String account, List<? extends Transaction> transactions)
     ...
     */
    double getAccountBalance(String account) throws AccountDoesNotExistException, TransactionDoesNotExistException;
